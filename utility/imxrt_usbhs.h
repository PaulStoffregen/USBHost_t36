...
#define USBPHYX_CTRL_CLR_(p)			((p)==1 ? USBPHY1_CTRL_CLR : USBPHY2_CTRL_CLR)
#define USBPHYX_CTRL_SET_(p)			((p)==1 ? USBPHY1_CTRL_SET : USBPHY2_CTRL_SET)
#define USBPHYX_PWD_(p)				((p)==1 ? USBPHY1_PWD : USBPHY2_PWD)
...
#define USBPHYX_CTRL_CLR_(p)			USBPHYX_CTRL_CLR
#define USBPHYX_CTRL_SET_(p)			USBPHYX_CTRL_SET
#define USBPHYX_PWD_(p)				USBPHYX_PWD
